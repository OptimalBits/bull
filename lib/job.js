...
Job.prototype.toData = function() {
  ...
  if (
    this.opts.sizeLimit &&
    utils.lengthInUtf8Bytes(json.data) > this.opts.sizeLimit
  ) {
    throw new Error(`The size of job ${this.opts.jobId || this.name || Job.DEFAULT_JOB_NAME} exceeds the limit ${this.opts.sizeLimit} bytes`);
  }
