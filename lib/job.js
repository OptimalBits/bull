...
//
// This could be atomized using "multi", since performance is not so critical in the failed
// case. For this to work we need to be able to define the lua commands at start up time.
//
