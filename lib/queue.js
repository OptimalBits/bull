...
var Queue = function Queue(name, redisPort, redisHost, redisOptions){
  ...
  Object.defineProperty(this, 'jobWaitCount', { get: function() {
    return this.bclient.commandQueue.length;
  } });
  Object.defineProperty(this, 'whenCurrentWaitFinished', { get: function() {
...
Queue.prototype.moveJob = function(src, dst, opts) {
  ...
  if(opts && opts.block === false){
    ...
    return Promise.resolve();
  } else if (this.jobWaitCount) {
    return this.whenCurrentWaitFinished.then(function() {
